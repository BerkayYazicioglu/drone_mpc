...
import gym
from lib.utils.enums import DroneModel, Physics, ImageType


class BaseEnv(gym.Env):
    """
        Base class for defining the simulation environment
    """
    ...
    def __init__(self,
        ...
        """Initialization of a generic environment.
        ...
        print("[INFO] Loaded parameters from the drone's .urdf:\n[INFO] m {:f}, L {:f},\n[INFO] ixx {:f}, iyy {:f}, izz {:f},\n[INFO] kf {:f}, km {:f},\n[INFO] t2w {:f}, max_speed_kmh {:f},\n[INFO] gnd_eff_coeff {:f}, prop_radius {:f},\n[INFO] drag_xy_coeff {:f}, drag_z_coeff {:f},\n[INFO] dw_coeff_1 {:f}, dw_coeff_2 {:f}, dw_coeff_3 {:f}".format(
    ...
    def render(self,
        ...
        if self.first_render_call and not self.GUI:
            print("[WARNING] BaseEnv.render() is implemented as text-only, re-initialize the environment using Aviary(gui=True) to use PyBullet's graphical interface")
            self.first_render_call = False
        print("\n[INFO] BaseEnv.render() ——— it {:04d}".format(self.step_counter),
        ...
        for i in range (self.NUM_DRONES):
            print("[INFO] BaseEnv.render() ——— drone {:d}".format(i),
    ...
    def _housekeeping(self):
        ...
        self.DRONE_IDS = np.array([p.loadURDF(pkg_resources.resource_filename('lib', 'assets/'+self.URDF),
                                              self.INIT_XYZS[i,:],
    ...
    def _parseURDFParameters(self):
        ...
        """
        URDF_TREE = etxml.parse(pkg_resources.resource_filename('lib', 'assets/'+self.URDF)).getroot()
    ...
    def _actionSpace(self):
        ...
        return gym.spaces.Dict({str(i): gym.spaces.Box(low=act_lower_bound,
    ...
    def _observationSpace(self):
        ...
        return gym.spaces.Dict({str(i): gym.spaces.Dict({"state": gym.spaces.Box(low=obs_lower_bound,
    ...
    def _computeObs(self):
        ...
        """
        return {str(i): {"state": self._getDroneStateVector(i)} for i in range(self.NUM_DRONES)}
